...
enum MediaPathMode : uint32_t {
  ...
  kCdmDecrypt = 2,           // The CDM can decrypt the input into clear.
  ...
  // The CdmProxy (with supporting decryptor) can decrypt the input into clear.
  kCdmProxyDecrypt = 5,
};
...
class CDM_CLASS_API Host_10 {
 public:
  ...
  // kCdmDecryptAndDecode, kCdmDecrypt, or kCdmTranscryptForCdmProxy the
