...
cdm::ContentDecryptionModule is a typedef of the latest stable CDM interface
and should always be supported by Chromium. It is also recommended that other
user agents also support the latest stable CDM interface.
